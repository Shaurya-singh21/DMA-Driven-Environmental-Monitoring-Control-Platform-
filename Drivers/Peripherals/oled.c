 ...
 */
static const uint8_t font[][5] = { { 0x00, 0x00, 0x00, 0x00, 0x00 }, /* ' ' */
...
void oled_init(void) {
	...
	oled_cmd(0x21);
	oled_cmd(0x00);
	oled_cmd(0x7F); /* col window 0-127     */
	oled_cmd(0x22);
	oled_cmd(0x00);
	oled_cmd(0x07); /* page window 0-7      */
...
void oled_flush(void) {
	...
	oled_cmd(0x21);
	oled_cmd(0x00);
	oled_cmd(0x7F); /* cols 0-127  */
	oled_cmd(0x22);
	oled_cmd(0x00);
	oled_cmd(0x07); /* pages 0-7   */
	...
	(void) I2C1->SR1;
	(void) I2C1->SR2; /* clear ADDR — I2C now in TX state */
